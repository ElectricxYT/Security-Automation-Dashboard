...
On Day Four, I finished the backend of Picket and created the base of the frontend. 
 - I started by creating a calculateFinalRisk method that would take in the risk scores from both VirusTotal and AbuseIPDB and come to a verdict on what the risk score should be. The higher risk score wins, as false positives are always better than false negatives.
